...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    <div class="ie-panel"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img src="images/ie8-panel/warning_bar_0000_us.jpg" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for  today."></a></div>
    <div class="preloader">
    ...
    <!-- Page-->
    <div class="page"><a class="d-none d-xl-block" href="https://www.templatemonster.com/website-templates/allstar-multi-sports-website-template-63853.html" target="blank"><img class="d-block w-100" src="" alt=""></a>
      <!-- Page Header-->
                    ...
                    <div class="owl-carousel-inline-wrap">
                      <div class="owl-carousel owl-carousel-inline" data-items="1" data-dots="false" data-nav="true" data-autoplay="true" data-autoplay-speed="3200" data-stage-padding="0" data-loop="true" data-margin="10" data-mouse-drag="false" data-touch-drag="false" data-nav-custom=".owl-carousel-navbar">
                        ...
                        <article class="post-inline">
                          <time class="post-inline-time" datetime="2024">Septiembre 15, 2024</time>
                          <p class="post-inline-title">Real Pasion vs Dream Team</p>
                        </article>
                        <!-- Post Inline-->
                        <article class="post-inline">
                          <time class="post-inline-time" datetime="2024">Octubre 24, 2024</time>
                          <p class="post-inline-title">Real Pasion vs Real Pasion</p>
                        </article>
                        <!-- Post Inline-->
                        <article class="post-inline">
                          <time class="post-inline-time" datetime="2024">Noviembre 16, 2024</time>
                          <p class="post-inline-title">Real Pasion vs Barcelona</p>
                        </article>
                      </div>
                    </div>
                  </div>
                        ...
                        <article class="cart-inline cart-inline-toggled" id="cart-inline">
                          <div class="cart-inline-inner">
                            <div class="cart-inline-header">
                              <h5 class="cart-inline-title">En carta: 2 productos</h5>
                              <p class="cart-inline-subtitle">total precio: $75.000</p>
                            </div>
                            <div class="cart-inline-main">
                                    <!-- Product inline-->
                                    <article class="product-inline">
                                      <div class="product-inline-aside"><a class="product-inline-figure" href="#"><img class="product-inline-image" src="img/cancha.jpeg" alt="" width="67" height="30"/></a></div>
                                      <div class="product-inline-main">
                                        <p class="heading-7 product-inline-title"><a href="#">Camiseta</a></p>
                                        <ul class="product-inline-meta">
                                          <li>
                                            <input class="form-input" type="number" data-zeros="true" value="2" min="1" max="100">
                                          </li>
                                          <li>
                                            <p class="product-inline-price">$50.000</p>
                                          </li>
                                        </ul>
                                      </div>
                                    </article>
                                    ...
                                    <article class="product-inline">
                                      ...
                                      <div class="product-inline-main">
                                        <p class="heading-7 product-inline-title"><a href="#">Camiseta Real Pasion</a></p>
                                        <ul class="product-inline-meta">
                                          <li>
                                            <input class="form-input" type="number" data-zeros="true" value="1" min="1" max="100">
                                          </li>
                                          <li>
                                            <p class="product-inline-price">$60.00</p>
                                          </li>
                                        </ul>
                                      </div>
                                    </article>
                            </div>
                            <div class="cart-inline-footer"><a class="button button-md button-default-outline" href="#">Ir al carrito</a><a class="button button-md button-primary" href="#">Verificar</a></div>
                          </div>
                        </article>
                      </div>
                    </li>
                    <li><a class="link link-icon link-icon-left link-classic" href="#"><span class="icon fl-bigmug-line-login12"></span><span class="link-icon-text">Su cuenta</span></a></li>
                  </ul>
                </div>
            ...
            <div class="rd-navbar-main">
              <div class="rd-navbar-main-top">
                <div class="rd-navbar-main-container container">
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><img class="brand-logo " src="img/logo.png" alt="" width="95" height="126"/></a>
                  </div>
                  <!-- RD Navbar List-->
                  <ul class="rd-navbar-list">
                    <li class="rd-navbar-list-item"><a class="rd-navbar-list-link" href="#"><img src="img/rexona.png" alt="" width="75" height="42"/></a></li>
                    <li class="rd-navbar-list-item"><a class="rd-navbar-list-link" href="#"><img src="img/puma.png" alt="" width="88" height="45"/></a></li>
                    <li class="rd-navbar-list-item"><a class="rd-navbar-list-link" href="#"><img src="img/umbro.png" alt="" width="79" height="52"/></a></li>
                  </ul>
                  <!-- RD Navbar Search-->
                  <div class="rd-navbar-search">
                    ...
                    <form class="rd-search" action="#" data-search-live="rd-search-results-live" method="GET">
                      <div class="form-wrap">
                        <label class="form-label" for="rd-navbar-search-form-input">Busca algo</label>
                ...
                <div class="rd-navbar-main-container container">
                  <!-- RD Navbar Nav-->
                                    <ul class="rd-navbar-nav">
                                      ...
                                      <li class="rd-nav-item"><a class="rd-nav-link" href="tbposiciones.html">Tabla de posiciones</a>
                                      </li>
                                      <li class="rd-nav-item"><a class="rd-nav-link" href="categorias.html">Categorias</a>
                                      </li>
                                      <li class="rd-nav-item"><a class="rd-nav-link" href="horarios.html">Horarios</a>
                                      </li>
                                      <li class="rd-nav-item"><a class="rd-nav-link" href="contacto.html">Contactanos</a>
                                      </li>
                  ...
                  <div class="rd-navbar-main-element">
                    <ul class="list-inline list-inline-sm">
                      <li><a class="icon icon-xs icon-light fa fa-facebook" href="https://www.facebook.com/people/Real-Pasi%C3%B3n-FC/100063746286057/"></a></li>
                      <li><a class="icon icon-xs icon-light fa fa-twitter" href=""></a></li>
                      <li><a class="icon icon-xs icon-light fa fa-google-plus" href="#"></a></li>
                      <li><a class="icon icon-xs icon-light fa fa-instagram" href="https://www.instagram.com/real.pasionfc?igsh=amt6eThkeHlwd2s1"></a></li>
                    </ul>
                  </div>
                </div>
              </div>
      ...
      <div class="body">
        <form class="form" action="login0.php" method="POST">
          ...
          <div class="inputForm">
            ...
            <input placeholder="Ingresa tu Email" class="input" type="text" name="txtEmail"/>
          </div>
          ...
          <div class="inputForm">
            ...
            <input placeholder="Ingresa tu contraseña" class="input" type="contraseña" name="txtContraseña"/>
          </div>
         ...
         <a href="admin.html"> <button class="button-submit">Sign In</button></a>
          <p class="p">No tienes una cuenta? <span class="span">Sign Up</span></p>
      ...
      <footer class="section footer-classic footer-classic-dark context-dark">
        <div class="footer-classic-main">
          <div class="container">
            <p class="heading-7">Se partde de nosotros</p>
            <!-- RD Mailform-->

            <div class="row row-50">
              <div class="col-lg-5 text-center text-sm-left">
                <article class="unit unit-sm-horizontal unit-middle justify-content-center justify-content-sm-start footer-classic-info">
                  <div class="unit-left"><img class="brand-logo " src="img/logo.png" alt="" width="95" height="126"/></a>
                  </div>
                  <div class="unit-body">
                    <p>Somos Real Pasión FC, llenos de pasión y determinación.Con el respaldo del mejor cuerpo técnico, estamos preparados para enfrentar todos los desafíos que se crucen en nuestro camino.</p>
                  </div>
                </article>
                <ul class="list-inline list-inline-bordered list-inline-bordered-lg">
                  <li>
                    <div class="unit unit-horizontal unit-middle">
                      ...
                      <div class="unit-body">
                        <h6>Únete a nuestro equipo</h6><a class="link" href="mailto:#">realpasion@gmail.com</a>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="unit unit-horizontal unit-middle">
                      ...
                      <div class="unit-body">
                        <h6>Contactanos</h6><a class="link" href="mailto:#">realpasion@gmail.com</a>
                      </div>
                    </div>
                  </li>
                </ul>
                <div class="group-md group-middle">
                  ...
                  </div><a class="button button-sm button-gray-outline" href="contact-us.html">Contactanos</a>
                </div>
              </div>
